	  ...
	  <br>
		   <div class="contact-box">
		       <form method="post" onsubmit="return contact_validate()">
			       <input type="text" class="input-field" placeholder="Your Name" id="name" name="mname">
				   <span style="color:red;" id="err_name"><?php echo $err_name;?></span>
				   <input type="text" class="input-field" placeholder="Your Email" id="email" name="memail">
				   <span style="color:red;" id="err_email"><?php echo $err_email;?></span>
				   <textarea type="text" class="input-field textarea-field" placeholder="Your Message" id="message" name="mmessage"></textarea>
				   <span style="color:red;" id="err_message"><?php echo $err_message;?></span>
				   <br>
				   <br>
				   <button type="submit" class="btn" name="msend">Send Message</button>
			   </form>
		   </div>
		  </div> 
